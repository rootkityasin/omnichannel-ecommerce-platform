    ...
    <div className={cn("w-full space-y-4", className)}>
        ...
        >
          {valuesArray.map((url, index) => (
            <div
              key={index}
              className={cn(
                "relative overflow-hidden rounded-lg border border-slate-200 group bg-slate-100",
      ...
      {valuesArray.length === 0 && (
        ...
        >
          ...
          <div
            className={cn(
              "p-4 rounded-full bg-slate-50 transition-colors",
          ...
          <div className="text-center space-y-1">
            <p className="text-sm font-medium text-slate-700">
              {isDragActive
                ? "Drop files here"
                : `Click or drag ${multiple ? "files" : "image"} to upload`}
            </p>
