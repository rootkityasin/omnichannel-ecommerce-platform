...
export function PolicyModal({ isOpen, onClose, title, content }: PolicyModalProps) {
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-slate-950 text-slate-200 border border-white/10 shadow-2xl shadow-black ring-1 ring-white/10 p-0 overflow-hidden rounded-xl">
                {/* Decorative Top Bar */}
                ...
                <div className="p-8 md:p-10 relative">
                    ...
                    <DialogHeader className="mb-8 text-center space-y-4 relative z-10">
                        <div className="flex flex-col items-center gap-3">
                            <span className="text-[10px] uppercase tracking-[0.3em] text-crab-red font-mono font-bold">Official Document</span>
