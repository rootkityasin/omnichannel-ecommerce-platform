...
export function HeroCarousel({ slides = [] }: { slides?: HeroSlide[] }) {
  ...
  return (
    <div
      className="relative overflow-hidden bg-gray-100 aspect-[4/3] md:aspect-[21/9]"
      ref={emblaRef}
    >
        ...
        {displaySlides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute z-20 left-6 bottom-8 max-w-[80%] text-white">
              ...
              >
                <span
                  className={`inline-block px-2.5 py-1 rounded-sm bg-crab-red text-white text-[8px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-widest font-bold mb-3 shadow-sm ${language !== "en" ? "font-bangla" : "font-body"}`}
                >
                  {language === "en"
                    ? slide.subtitle || ""
                    : slide.subtitle_bn || slide.subtitle || ""}
                </span>
                <h2
                  className={`text-4xl font-heading font-bold leading-tight drop-shadow-lg mb-2 ${language !== "en" ? "font-bangla" : "font-heading"}`}
                >
                  {language === "en"
                    ? slide.title
