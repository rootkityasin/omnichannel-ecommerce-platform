        ...
        className={cn(
          ...
          isOpen
            ...
            : // Closed state:
              ...
              isTransparent
              ? "bg-[#0A3D62]/5 hover:bg-[#0A3D62]/10 text-[#0A3D62] border-[#0A3D62]/10"
              : "bg-transparent hover:bg-slate-100 text-slate-800 border-slate-200",
          "h-10 rounded-full",
        ...
        {isOpen && searchTerm.length > 0 && (
          ...
          >
            {suggestions.length > 0 ? (
                ...
                {suggestions.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-crab-red font-black font-heading">
                        ৳{item.price}
                      </p>
                    </div>
                  </div>
              ...
              <div
                className={`p-4 text-center text-sm text-gray-400 ${language !== "en" ? "font-bangla" : "font-body"}`}
              >
                {t.noItemsFound}
              </div>
            )}
