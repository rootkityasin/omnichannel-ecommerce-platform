                        ...
                        <motion.button
                            className={cn(
                                ...
                                isSidebarOpen
                                    ...
                                    : !isTransparent ? "text-ocean-blue hover:bg-slate-100" : "text-white hover:bg-white/10"
                            )}
                        ...
                        <Link href="/" className={cn("flex items-center gap-2 group transition-opacity duration-300", isSidebarOpen && "opacity-0 pointer-events-none")}>
                            {config?.logoUrl ? (
                                ...
                                <span className={cn(
                                    ...
                                    !isTransparent ? "text-2xl text-ocean-blue" : "text-3xl text-white drop-shadow-sm"
                                )}>
                            ...
                            return (
                                <Link
                                    ...
                                    className={cn(
                                        ...
                                        isActive
                                            ? "text-crab-red"
                                            : !isTransparent ? "text-ocean-blue hover:text-crab-red" : "text-ocean-blue hover:text-crab-red" // Keep dark blue for nav inside specific container
                                    )}
                                >
                                    {item.label}
                                    {isActive && (
