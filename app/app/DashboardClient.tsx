          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className={`gap-2 h-10 border-slate-200 bg-white text-slate-700 hover:bg-slate-50 shadow-sm min-w-[100px] justify-between ${selectedPlan ? "border-emerald-200 bg-emerald-50 text-emerald-700" : ""}`}
                >
