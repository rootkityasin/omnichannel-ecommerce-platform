...
import {
  fetchSiteConfig,
  saveSiteConfig,
} from "@/app/[domain]/actions/settings";
...
export default function ThemeSettingsPage() {
  ...
  }, [primaryColor, secondaryColor, previewEnabled]);
        ...
        >
          ...
          <Card className="flex-1 p-5 border-0 shadow-xl bg-white/80 backdrop-blur-xl ring-1 ring-slate-900/5 flex flex-col gap-6 overflow-y-auto">
                ...
                <div className="group">
                  ...
                  <div className="flex items-center gap-3 bg-white p-1.5 rounded-xl shadow-sm border border-slate-100 group-hover:border-slate-200 transition-colors">
                    ...
                    <Input
                      value={primaryColor}
                      onChange={(e) => setPrimaryColor(e.target.value)}
                      className="font-mono uppercase text-xs h-8 border-0 bg-transparent px-0"
                    />
                  </div>
                </div>
            ...
            <div className="mt-auto pt-4 border-t border-slate-100 flex flex-col gap-2">
              ...
              <button
                onClick={() => {
                  setPrimaryColor("#F40000");
                  setSecondaryColor("#0f172a");
                }}
                className="w-full py-3 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 transition-colors text-xs font-bold flex items-center justify-center gap-2"
              >
                      ...
                      <div className="flex gap-1.5">
                        <div className="w-3 h-3 text-white">
                          <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 21a9 9 0 0 1-9-9c0-4.97 4.03-9 9-9 9 9 0 0 1 9 9c0 4.97-4.03 9-9 9zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S16.627 0 12 0z" />
                          </svg>
                        </div>
                      </div>
                    </div>
